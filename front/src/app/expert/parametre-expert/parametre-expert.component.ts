...
@Component({
  selector: 'app-parametre-expert',
  templateUrl: './parametre-expert.component.html',
  styleUrls: ['./parametre-expert.component.css']
})
export class ParametreExpertComponent implements OnInit {
...
newEmail;
  ...
  modifierDomaine(newDomaine){
    this.userService.ModifierDomaine(this.email,newDomaine).subscribe(
      res => {
        this.toastr.info('Domaine Modified' , 'Success!');
